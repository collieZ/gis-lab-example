...
function geodGBL() {
  ...
  tstglobal = typeof window.EARTH_A;
...
function earthcon(ai, bi) {
  /*        Sets Earth Constants as globals
             --  input a,b
             --  Leaves Globals 
                 window.EARTH_A      window.EARTH_B   window.EARTH_F  window.EARTH_Ecc
*/
  ...
  window.EARTH_B = b;
  window.EARTH_F = f;
  window.EARTH_Ecc = ecc;
  window.EARTH_Esq = eccsq;
}
...
export function llhxyz(flati, floni, altkmi) {
